...
export const supabase = createClient<Database>(SUPABASE_URL, SUPABASE_PUBLISHABLE_KEY, {
  auth: {
    // Toto je nejdůležitější část pro zapamatování přihlášení:
    storage: localStorage,    // Říká Supabase, aby použil trvalé úložiště prohlížeče.
    persistSession: true,   // Explicitně zapíná pamatování session.
    autoRefreshToken: true, // Automaticky obnovuje přihlášení, aby nevypršelo.
  }
});
